...
/**
 * Implementation of {@link com.mds.decisionsupport.model.NaturalPerson}
...
public class NaturalPersonImpl extends com.ibm.adtech.jastor.ThingImpl implements com.mds.decisionsupport.model.NaturalPerson {
	...
	NaturalPersonImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static NaturalPersonImpl getNaturalPerson(Resource resource, Model model) throws JastorException {
		return new NaturalPersonImpl(resource, model);
	}
	    
	static NaturalPersonImpl createNaturalPerson(Resource resource, Model model) throws JastorException { 
		NaturalPersonImpl impl = new NaturalPersonImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, NaturalPerson.TYPE)))
			impl._model.add(impl._resource, RDF.type, NaturalPerson.TYPE);
		impl.addSuperTypes();
	...
	public java.lang.String getLastName() throws JastorException {
		...
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": lastName getProperty() in com.mds.decisionsupport.model.NaturalPerson model not Literal", stmt.getObject());
	...
	public com.hp.hpl.jena.datatypes.xsd.XSDDateTime getBirthDate() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": birthDate getProperty() in com.mds.decisionsupport.model.NaturalPerson model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public java.lang.String getEmail() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": email getProperty() in com.mds.decisionsupport.model.NaturalPerson model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(true,literal,"java.lang.String","http://www.w3.org/2001/XMLSchema#string");
	...
	public java.lang.String getFirstName() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": firstName getProperty() in com.mds.decisionsupport.model.NaturalPerson model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(true,literal,"java.lang.String","http://www.w3.org/2001/XMLSchema#string");
	...
	public java.math.BigInteger getAdress() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": adress getProperty() in com.mds.decisionsupport.model.NaturalPerson model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public java.lang.String getPhoneNumber() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": phoneNumber getProperty() in com.mds.decisionsupport.model.NaturalPerson model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(true,literal,"java.lang.String","http://www.w3.org/2001/XMLSchema#string");
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof NaturalPersonListener))
			throw new IllegalArgumentException("ThingListener must be instance of NaturalPersonListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((NaturalPersonListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
			...
			if (stmt.getPredicate().equals(lastNameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						NaturalPersonListener listener=(NaturalPersonListener)iter.next();
						listener.lastNameChanged(com.mds.decisionsupport.model.NaturalPersonImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(birthDateProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						NaturalPersonListener listener=(NaturalPersonListener)iter.next();
						listener.birthDateChanged(com.mds.decisionsupport.model.NaturalPersonImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(emailProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						NaturalPersonListener listener=(NaturalPersonListener)iter.next();
						listener.emailChanged(com.mds.decisionsupport.model.NaturalPersonImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(firstNameProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						NaturalPersonListener listener=(NaturalPersonListener)iter.next();
						listener.firstNameChanged(com.mds.decisionsupport.model.NaturalPersonImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(adressProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						NaturalPersonListener listener=(NaturalPersonListener)iter.next();
						listener.adressChanged(com.mds.decisionsupport.model.NaturalPersonImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(phoneNumberProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						NaturalPersonListener listener=(NaturalPersonListener)iter.next();
						listener.phoneNumberChanged(com.mds.decisionsupport.model.NaturalPersonImpl.this);
					}
				}
				return;
			}
