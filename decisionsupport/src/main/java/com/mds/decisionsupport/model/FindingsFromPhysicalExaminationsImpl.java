...
/**
 * Implementation of {@link com.mds.decisionsupport.model.FindingsFromPhysicalExaminations}
 ...
 * <br>
 */
public class FindingsFromPhysicalExaminationsImpl extends com.ibm.adtech.jastor.ThingImpl implements com.mds.decisionsupport.model.FindingsFromPhysicalExaminations {
	...
	FindingsFromPhysicalExaminationsImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static FindingsFromPhysicalExaminationsImpl getFindingsFromPhysicalExaminations(Resource resource, Model model) throws JastorException {
		return new FindingsFromPhysicalExaminationsImpl(resource, model);
	}
	    
	static FindingsFromPhysicalExaminationsImpl createFindingsFromPhysicalExaminations(Resource resource, Model model) throws JastorException { 
		FindingsFromPhysicalExaminationsImpl impl = new FindingsFromPhysicalExaminationsImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, FindingsFromPhysicalExaminations.TYPE)))
			impl._model.add(impl._resource, RDF.type, FindingsFromPhysicalExaminations.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, com.mds.decisionsupport.model.FindingsFromPhysicalExaminations.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initHasGeographicalLocation() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://ontology/mds#hasGeographicalLocation properties in FindingsFromPhysicalExaminations model not a Resource", stmt.getObject());
	...
	public com.hp.hpl.jena.datatypes.xsd.XSDDateTime getEndDateOfMedicalItem() throws JastorException {
		...
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": endDateOfMedicalItem getProperty() in com.mds.decisionsupport.model.FindingsFromPhysicalExaminations model not Literal", stmt.getObject());
	...
	private void initHasSource_asNaturalPerson() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://ontology/mds#hasSource properties in FindingsFromPhysicalExaminations model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public com.hp.hpl.jena.datatypes.xsd.XSDDateTime getStartDateOfMedicalItem() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": startDateOfMedicalItem getProperty() in com.mds.decisionsupport.model.FindingsFromPhysicalExaminations model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(true,literal,"com.hp.hpl.jena.datatypes.xsd.XSDDateTime","http://www.w3.org/2001/XMLSchema#dateTime");
	...
	public com.hp.hpl.jena.datatypes.xsd.XSDDateTime getHasEffectTime() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": hasEffectTime getProperty() in com.mds.decisionsupport.model.FindingsFromPhysicalExaminations model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(true,literal,"com.hp.hpl.jena.datatypes.xsd.XSDDateTime","http://www.w3.org/2001/XMLSchema#dateTime");
	...
	private void initHasNomenclatureCode() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://ontology/mds#hasNomenclatureCode properties in FindingsFromPhysicalExaminations model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initIsPartOf() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://ontology/mds#isPartOf properties in FindingsFromPhysicalExaminations model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHasMedicalObject() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://ontology/mds#hasMedicalObject properties in FindingsFromPhysicalExaminations model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHasContext() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://ontology/mds#hasContext properties in FindingsFromPhysicalExaminations model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public java.lang.String getCommentOfMedicalItem() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": commentOfMedicalItem getProperty() in com.mds.decisionsupport.model.FindingsFromPhysicalExaminations model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHasAmount() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://ontology/mds#hasAmount properties in FindingsFromPhysicalExaminations model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public com.hp.hpl.jena.datatypes.xsd.XSDDateTime getHasTimeStamp() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": hasTimeStamp getProperty() in com.mds.decisionsupport.model.FindingsFromPhysicalExaminations model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(true,literal,"com.hp.hpl.jena.datatypes.xsd.XSDDateTime","http://www.w3.org/2001/XMLSchema#dateTime");
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof FindingsFromPhysicalExaminationsListener))
			throw new IllegalArgumentException("ThingListener must be instance of FindingsFromPhysicalExaminationsListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((FindingsFromPhysicalExaminationsListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasGeographicalLocation.iterator();iter.hasNext();){
							FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
							listener.hasGeographicalLocationAdded(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this,_hasGeographicalLocation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(endDateOfMedicalItemProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
						listener.endDateOfMedicalItemChanged(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this);
					}
				}
				return;
			}
				...
				if (_model.contains(resource,RDF.type,com.mds.decisionsupport.model.NaturalPerson.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasSource_asNaturalPerson.iterator();iter.hasNext();){
							FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
							listener.hasSourceAdded(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this,_hasSource_asNaturalPerson);
						}
					}
				}
				if (_model.contains(resource,RDF.type,com.mds.decisionsupport.model.SensingDevice.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasSource_asSensingDevice.iterator();iter.hasNext();){
							FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
							listener.hasSourceAdded(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this,_hasSource_asSensingDevice);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(startDateOfMedicalItemProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
						listener.startDateOfMedicalItemChanged(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(hasEffectTimeProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
						listener.hasEffectTimeChanged(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasNomenclatureCode.iterator();iter.hasNext();){
							FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
							listener.hasNomenclatureCodeAdded(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this,_hasNomenclatureCode);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForIsPartOf.iterator();iter.hasNext();){
							FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
							listener.isPartOfAdded(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this,_isPartOf);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasMedicalObject.iterator();iter.hasNext();){
							FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
							listener.hasMedicalObjectAdded(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this,_hasMedicalObject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasContextProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHasContext.iterator();iter.hasNext();){
						FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
						listener.hasContextAdded(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(commentOfMedicalItemProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
						listener.commentOfMedicalItemChanged(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasAmount.iterator();iter.hasNext();){
							FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
							listener.hasAmountAdded(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this,_hasAmount);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasTimeStampProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
						listener.hasTimeStampChanged(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(hasGeographicalLocationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasGeographicalLocation.iterator();iter.hasNext();){
							FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
							listener.hasGeographicalLocationRemoved(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this,_hasGeographicalLocation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasSourceProperty)) {
				...
				if (_model.contains(resource,RDF.type,com.mds.decisionsupport.model.NaturalPerson.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasSource_asNaturalPerson.iterator();iter.hasNext();){
							FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
							listener.hasSourceRemoved(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this,_hasSource_asNaturalPerson);
						}
					}
				}
				if (_model.contains(resource,RDF.type,com.mds.decisionsupport.model.SensingDevice.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasSource_asSensingDevice.iterator();iter.hasNext();){
							FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
							listener.hasSourceRemoved(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this,_hasSource_asSensingDevice);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasNomenclatureCodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasNomenclatureCode.iterator();iter.hasNext();){
							FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
							listener.hasNomenclatureCodeRemoved(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this,_hasNomenclatureCode);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(isPartOfProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForIsPartOf.iterator();iter.hasNext();){
							FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
							listener.isPartOfRemoved(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this,_isPartOf);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasMedicalObjectProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasMedicalObject.iterator();iter.hasNext();){
							FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
							listener.hasMedicalObjectRemoved(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this,_hasMedicalObject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasContextProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHasContext.iterator();iter.hasNext();){
						FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
						listener.hasContextRemoved(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this,literal);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(hasAmountProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasAmount.iterator();iter.hasNext();){
							FindingsFromPhysicalExaminationsListener listener=(FindingsFromPhysicalExaminationsListener)iter.next();
							listener.hasAmountRemoved(com.mds.decisionsupport.model.FindingsFromPhysicalExaminationsImpl.this,_hasAmount);
						}
					}
				}
				return;
