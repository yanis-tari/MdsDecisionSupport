...
/**
 * Implementation of {@link com.mds.decisionsupport.model.Plan}
...
public class PlanImpl extends com.ibm.adtech.jastor.ThingImpl implements com.mds.decisionsupport.model.Plan {
	...
	PlanImpl(Resource resource, Model model) throws JastorException {
		super(resource, model);
		setupModelListener();
	}     
    	
	static PlanImpl getPlan(Resource resource, Model model) throws JastorException {
		return new PlanImpl(resource, model);
	}
	    
	static PlanImpl createPlan(Resource resource, Model model) throws JastorException { 
		PlanImpl impl = new PlanImpl(resource, model);
		
		if (!impl._model.contains(new com.hp.hpl.jena.rdf.model.impl.StatementImpl(impl._resource, RDF.type, Plan.TYPE)))
			impl._model.add(impl._resource, RDF.type, Plan.TYPE);
		impl.addSuperTypes();
	...
	public java.util.List listStatements() {
		...
		it = _model.listStatements(_resource,RDF.type, com.mds.decisionsupport.model.Plan.TYPE);
		while (it.hasNext()) {
			list.add(it.next());
		}
	...
	private void initHasGeographicalLocation() throws JastorException {
		...
		while(it.hasNext()) {
			...
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://ontology/mds#hasGeographicalLocation properties in Plan model not a Resource", stmt.getObject());
	...
	public com.hp.hpl.jena.datatypes.xsd.XSDDateTime getEndDateOfMedicalItem() throws JastorException {
		...
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": endDateOfMedicalItem getProperty() in com.mds.decisionsupport.model.Plan model not Literal", stmt.getObject());
	...
	private void initHasSource_asNaturalPerson() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://ontology/mds#hasSource properties in Plan model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
	...
	public com.hp.hpl.jena.datatypes.xsd.XSDDateTime getStartDateOfMedicalItem() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": startDateOfMedicalItem getProperty() in com.mds.decisionsupport.model.Plan model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(true,literal,"com.hp.hpl.jena.datatypes.xsd.XSDDateTime","http://www.w3.org/2001/XMLSchema#dateTime");
	...
	public com.hp.hpl.jena.datatypes.xsd.XSDDateTime getHasEffectTime() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": hasEffectTime getProperty() in com.mds.decisionsupport.model.Plan model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(true,literal,"com.hp.hpl.jena.datatypes.xsd.XSDDateTime","http://www.w3.org/2001/XMLSchema#dateTime");
	...
	private void initHasNomenclatureCode() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://ontology/mds#hasNomenclatureCode properties in Plan model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initIsPartOf() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://ontology/mds#isPartOf properties in Plan model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHasMedicalObject() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://ontology/mds#hasMedicalObject properties in Plan model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	private void initHasContext() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://ontology/mds#hasContext properties in Plan model not a Literal", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	public java.lang.String getCommentOfMedicalItem() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": commentOfMedicalItem getProperty() in com.mds.decisionsupport.model.Plan model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
	...
	private void initHasAmount() throws JastorException {
		...
		while(it.hasNext()) {
			com.hp.hpl.jena.rdf.model.Statement stmt = (com.hp.hpl.jena.rdf.model.Statement)it.next();
			if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Resource.class))
				throw new JastorInvalidRDFNodeException (uri() + ": One of the http://ontology/mds#hasAmount properties in Plan model not a Resource", stmt.getObject());
			com.hp.hpl.jena.rdf.model.Resource resource = (com.hp.hpl.jena.rdf.model.Resource) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Resource.class);
			if (true) { // don't check resource type if the property range is Resource
	...
	public com.hp.hpl.jena.datatypes.xsd.XSDDateTime getHasTimeStamp() throws JastorException {
		...
		if (stmt == null)
			return null;
		if (!stmt.getObject().canAs(com.hp.hpl.jena.rdf.model.Literal.class))
			throw new JastorInvalidRDFNodeException(uri() + ": hasTimeStamp getProperty() in com.mds.decisionsupport.model.Plan model not Literal", stmt.getObject());
		com.hp.hpl.jena.rdf.model.Literal literal = (com.hp.hpl.jena.rdf.model.Literal) stmt.getObject().as(com.hp.hpl.jena.rdf.model.Literal.class);
		Object obj = Util.fixLiteral(true,literal,"com.hp.hpl.jena.datatypes.xsd.XSDDateTime","http://www.w3.org/2001/XMLSchema#dateTime");
	...
	public void registerListener(ThingListener listener) {
		if (!(listener instanceof PlanListener))
			throw new IllegalArgumentException("ThingListener must be instance of PlanListener"); 
		if (listeners == null)
			setupModelListener();
		if(!this.listeners.contains(listener)){
			this.listeners.add((PlanListener)listener);
		}
	}
		...
		public void addedStatement(com.hp.hpl.jena.rdf.model.Statement stmt) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasGeographicalLocation.iterator();iter.hasNext();){
							PlanListener listener=(PlanListener)iter.next();
							listener.hasGeographicalLocationAdded(com.mds.decisionsupport.model.PlanImpl.this,_hasGeographicalLocation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(endDateOfMedicalItemProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						PlanListener listener=(PlanListener)iter.next();
						listener.endDateOfMedicalItemChanged(com.mds.decisionsupport.model.PlanImpl.this);
					}
				}
				return;
			}
				...
				if (_model.contains(resource,RDF.type,com.mds.decisionsupport.model.NaturalPerson.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasSource_asNaturalPerson.iterator();iter.hasNext();){
							PlanListener listener=(PlanListener)iter.next();
							listener.hasSourceAdded(com.mds.decisionsupport.model.PlanImpl.this,_hasSource_asNaturalPerson);
						}
					}
				}
				if (_model.contains(resource,RDF.type,com.mds.decisionsupport.model.SensingDevice.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasSource_asSensingDevice.iterator();iter.hasNext();){
							PlanListener listener=(PlanListener)iter.next();
							listener.hasSourceAdded(com.mds.decisionsupport.model.PlanImpl.this,_hasSource_asSensingDevice);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(startDateOfMedicalItemProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						PlanListener listener=(PlanListener)iter.next();
						listener.startDateOfMedicalItemChanged(com.mds.decisionsupport.model.PlanImpl.this);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(hasEffectTimeProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						PlanListener listener=(PlanListener)iter.next();
						listener.hasEffectTimeChanged(com.mds.decisionsupport.model.PlanImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasNomenclatureCode.iterator();iter.hasNext();){
							PlanListener listener=(PlanListener)iter.next();
							listener.hasNomenclatureCodeAdded(com.mds.decisionsupport.model.PlanImpl.this,_hasNomenclatureCode);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForIsPartOf.iterator();iter.hasNext();){
							PlanListener listener=(PlanListener)iter.next();
							listener.isPartOfAdded(com.mds.decisionsupport.model.PlanImpl.this,_isPartOf);
						}
					}
				}
				return;
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasMedicalObject.iterator();iter.hasNext();){
							PlanListener listener=(PlanListener)iter.next();
							listener.hasMedicalObjectAdded(com.mds.decisionsupport.model.PlanImpl.this,_hasMedicalObject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasContextProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHasContext.iterator();iter.hasNext();){
						PlanListener listener=(PlanListener)iter.next();
						listener.hasContextAdded(com.mds.decisionsupport.model.PlanImpl.this,literal);
					}
				}
				return;
			}
			if (stmt.getPredicate().equals(commentOfMedicalItemProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						PlanListener listener=(PlanListener)iter.next();
						listener.commentOfMedicalItemChanged(com.mds.decisionsupport.model.PlanImpl.this);
					}
				}
				return;
			}
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasAmount.iterator();iter.hasNext();){
							PlanListener listener=(PlanListener)iter.next();
							listener.hasAmountAdded(com.mds.decisionsupport.model.PlanImpl.this,_hasAmount);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasTimeStampProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumers.iterator();iter.hasNext();){
						PlanListener listener=(PlanListener)iter.next();
						listener.hasTimeStampChanged(com.mds.decisionsupport.model.PlanImpl.this);
					}
				}
				return;
			}
...
//				return;
			if (stmt.getPredicate().equals(hasGeographicalLocationProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasGeographicalLocation.iterator();iter.hasNext();){
							PlanListener listener=(PlanListener)iter.next();
							listener.hasGeographicalLocationRemoved(com.mds.decisionsupport.model.PlanImpl.this,_hasGeographicalLocation);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasSourceProperty)) {
				...
				if (_model.contains(resource,RDF.type,com.mds.decisionsupport.model.NaturalPerson.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasSource_asNaturalPerson.iterator();iter.hasNext();){
							PlanListener listener=(PlanListener)iter.next();
							listener.hasSourceRemoved(com.mds.decisionsupport.model.PlanImpl.this,_hasSource_asNaturalPerson);
						}
					}
				}
				if (_model.contains(resource,RDF.type,com.mds.decisionsupport.model.SensingDevice.TYPE)) {
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasSource_asSensingDevice.iterator();iter.hasNext();){
							PlanListener listener=(PlanListener)iter.next();
							listener.hasSourceRemoved(com.mds.decisionsupport.model.PlanImpl.this,_hasSource_asSensingDevice);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasNomenclatureCodeProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasNomenclatureCode.iterator();iter.hasNext();){
							PlanListener listener=(PlanListener)iter.next();
							listener.hasNomenclatureCodeRemoved(com.mds.decisionsupport.model.PlanImpl.this,_hasNomenclatureCode);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(isPartOfProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForIsPartOf.iterator();iter.hasNext();){
							PlanListener listener=(PlanListener)iter.next();
							listener.isPartOfRemoved(com.mds.decisionsupport.model.PlanImpl.this,_isPartOf);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasMedicalObjectProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasMedicalObject.iterator();iter.hasNext();){
							PlanListener listener=(PlanListener)iter.next();
							listener.hasMedicalObjectRemoved(com.mds.decisionsupport.model.PlanImpl.this,_hasMedicalObject);
						}
					}
				}
				return;
			...
			if (stmt.getPredicate().equals(hasContextProperty)) {
				...
				if (listeners != null) {
					...
					for(java.util.Iterator iter=consumersForHasContext.iterator();iter.hasNext();){
						PlanListener listener=(PlanListener)iter.next();
						listener.hasContextRemoved(com.mds.decisionsupport.model.PlanImpl.this,literal);
					}
				}
				return;
			}
			...
			if (stmt.getPredicate().equals(hasAmountProperty)) {
				...
				if (true) { // don't check resource type if the property range is Resource
					...
					if (listeners != null) {
						...
						for(java.util.Iterator iter=consumersForHasAmount.iterator();iter.hasNext();){
							PlanListener listener=(PlanListener)iter.next();
							listener.hasAmountRemoved(com.mds.decisionsupport.model.PlanImpl.this,_hasAmount);
						}
					}
				}
				return;
